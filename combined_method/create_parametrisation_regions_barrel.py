...
variable = "abs(beta_outer - beta_inner)"
...
if not os.path.isdir(path):
    os.makedirs(path)
os.chdir(path)
o = ROOT.TFile("control_plots_barrel_{}.root".format(varname), 'RECREATE')
param_out = open('fitparameters_barrel_{}.csv'.format(varname), 'w')
