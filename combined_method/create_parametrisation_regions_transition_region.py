...
if not os.path.isdir(path):
    os.makedirs(path)
os.chdir(path)
o = ROOT.TFile("control_plots_transition_region.root", 'RECREATE')
param_out = open('fitparameters_transition_region.csv', 'w')
...
for pm in plus_minus:
    for eb in eta_boundary:
        for cs in chamber_size:
            r = fit_parametrisation(t, b_pt_i, b_pt_f, 0, 0, 1,
                                    cs, eb, pm)
            param_out.write('0,1,{},{},{},{},{},{},{},{},{},{},{},{},\
